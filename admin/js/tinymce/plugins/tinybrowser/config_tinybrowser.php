...
$_SESSION['IMAGE_MANAGER_PATH'] = '/var/www/vhosts/checksample.co.uk/fortdoors.checksample.co.uk//httpdocs/upload/';
$_SESSION['DWS_BASE_URL'] = 'http://fortdoors.checksample.co.uk//'; 
...
$_SESSION['tinybrowser']['docroot'] = rtrim($_SESSION['IMAGE_MANAGER_PATH'],'/');
...
$_SESSION['tinybrowser']['link']['image'] = '/upload'.$_SESSION['tinybrowser']['path']['image']; // Image links
$_SESSION['tinybrowser']['link']['media'] = '/upload'.$_SESSION['tinybrowser']['path']['media']; // Banner links
$_SESSION['tinybrowser']['link']['file']  = '/upload'.$_SESSION['tinybrowser']['path']['file']; // Other file links
