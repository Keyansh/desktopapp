...
!function (d) {
    ...
    var A = function (d, N) {
        this.element = d, this.preferred_country = "undefined" != typeof N ? N.preferred_country : ["GB"], this.display_error = "undefined" != typeof N ? N.display_error : "on", this.error_message = "undefined" != typeof N ? N.error_message : A.DEFAULTS.error_message
    };
    A.VERSION = "0.0.1", A.DEFAULTS = {
        ...
        template: '<div class="input-group"><div class="input-group-btn"><button type="button" id="btn-country" class="btn btn-default  f16 dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><span class="flag @cca2 btn-flag"></span><span class="btn-cc">&nbsp;&nbsp; +@callingCode &nbsp;&nbsp;</span><span class="caret"></span></button> <ul class="dropdown-menu f16">@country_items</ul></div><input style="border: none;border-bottom:1px solid black;height:36px;" type="text" name="customer_phone[]" class="form-control phone-custom" placeholder="Phone Number" size="25" /><input type="hidden" name="defaultCountry" id="defaultCountry" size="2" value="@cca2" /><input type="hidden" name="carrierCode" id="carrierCode" size="2" value="@callingCode" /></div>'
        ...
        if ("string" == typeof this.display_error && "on" == this.display_error)
            d.attr("data-container", "body"), d.attr("data-toggle", "popover"), d.attr("data-placement", "right"), d.attr("data-content", N), d.popover("show");
        else {
            if ("object" != typeof this.display_error)
                return;
    ...
    if (N[0] < 2 && N[1] < 9 || 1 == N[0] && 9 == N[1] && N[2] < 1 || N[0] > 2)
    ...
    n.VERSION = "3.3.6", n.prototype.toggle = function ($) {
        ...
        if (!e.is(".disabled, :disabled")) {
            ...
            if (A(), !n) {
                ...
                if (t.trigger($ = d.Event("show.bs.dropdown", a)), $.isDefaultPrevented())
                    return;
        ...
        if (/(38|40|27|32)/.test(A.which) && !/input|textarea/i.test(A.target.tagName)) {
            ...
            if (A.preventDefault(), A.stopPropagation(), !$.is(".disabled, :disabled")) {
                ...
                if (!n && 27 != A.which || n && 27 == A.which)
                    return 27 == A.which && e.find(t).trigger("focus"), $.trigger("click");
    ...
    A.VERSION = "3.3.6", A.TRANSITION_DURATION = 150, A.DEFAULTS = {
        ...
        if (!this.$tip && (this.$tip = d(this.options.template), 1 != this.$tip.length))
    ...
    function N(d, N) {
        ...
        A.prototype = N.prototype, d.ha = N.prototype, d.prototype = new A, d.prototype.constructor = d, d.ma = function (d, A) {
            for (var $ = Array(arguments.length - 2), e = 2; e < arguments.length; e++)
                $[e - 2] = arguments[e];
    ...
    function $(d) {
        for (var N = d.split("%s"), A = "", $ = Array.prototype.slice.call(arguments, 1); $.length && 1 < N.length; )
            A += N.shift() + $.shift();
        return A + N.join("%s")
    }
        ...
        for (var A = h(d.h()), $ = 0; $ < A.length; $++) {
            ...
            if (y(N, t)) {
                ...
                if (e.f)
                    ...
                    e = b(N, t), n ? (n = b(d, t)) ? v(n, e) : E(d, t, e.clone()) : E(d, t, e)
            }
        }
    }
    ...
    function Nd(d, N) {
        for (var A, $ = d.length, e = 0; $ > e; ++e) {
            A = d[e];
            var t = M(A, 3);
            if ((0 == t || 0 == N.search(S(A, 3, t - 1))) && (t = new RegExp(S(A, 1)), fd(t, N)))
                return A
        }
        return null
    }
    ...
    function pd(d, N, A, $, e) {
        ...
        if (0 == n.length)
            ...
            n = n.replace(AN, ""), B(d), d.a(H(n)), t = 1;
        else {
        ...
        if (null != N && (t = T(N, 10), n = "" + t, a = d.toString(), 0 == a.lastIndexOf(n, 0))) {
            var i = new L(a.substring(n.length)),
                    a = S(N, 1),
                    n = new RegExp(T(a, 2));
            if (gd(i, N, null), N = i.toString(), a = T(a, 3), !fd(n, d.toString()) && fd(n, N) || 3 == ld(a, d.toString()))
    ...
    function hd(d, N, A, $) {
        ...
        if (t > 0) {
            ...
            e.a(V(N));
        if (t = e.toString(), n = t.indexOf(";isub="), n > 0 && (B(e), e.a(t.substring(0, n))), !k(e.toString()))
            throw "The string supplied did not seem to be a phone number";
        if (t = e.toString(), !(Y(A) || null != t && 0 < t.length && AN.test(t)))
            throw "Invalid country calling code";
        t = new D, $ && E(t, 5, N);
        d: {
        ...
        try {
            ...
            if ("Invalid country calling code" != r || !AN.test(i))
                throw r;
            if (i = i.replace(AN, ""), a = pd(i, n, N, $, t), 0 == a)
                throw r
        }
        if (0 != a ? (e = rd(a), e != A && (n = j(d, a, e))) : (Z(e), N.a(e.toString()), null != A ? (a = T(n, 10), E(t, 1, a)) : $ && I(t, 6)), 2 > N.b.length)
            throw "The string supplied is too short to be a phone number";
        if (null != n && (d = new L, A = new L(N.toString()), gd(A, n, d), e = A.toString(), n = S(n, 1), n = T(n, 3), 2 != ld(n, e) && (N = A, $ && E(t, 7, d.toString()))), $ = N.toString(), d = $.length, 2 > d)
            throw "The string supplied is too short to be a phone number";
        if (d > 17)
            throw "The string supplied is too long to be a phone number";
        if (1 < $.length && "0" == $.charAt(0)) {
            for (E(t, 4, !0), d = 1; d < $.length - 1 && "0" == $.charAt(d); )
                d++;
            1 != d && E(t, 8, d)
        }
    ...
    var yd, bd = Array.prototype,
        ...
        if ($ = null == $ ? 0 : 0 > $ ? Math.max(0, N.length + $) : $, d(N))
    ...
    m.prototype.clone = function () {
        ...
        if ($ === String) {
            if ("number" == typeof A)
                return String(A)
        } else if ($ === Number && d(A) && ("Infinity" === A || "-Infinity" === A || "NaN" === A || /^-?[0-9]+$/.test(A)))
            return Number(A);
        return A
        ...
        for (A in N) {
            ...
            if (e = a ? $.a[parseInt(A, 10)] || null : f($, A))
                if (e.f)
                    ...
                    t = this.a(e, t), E(d, e.a, t);
            else
                a ? (e = d, a = Number(A), e.b[a] = t, e.a && delete e.a[a]) : n("Failed to find field: " + e)
        }
