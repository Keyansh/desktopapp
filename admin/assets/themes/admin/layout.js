...
$(document).ready(function () {
    ...
    $(function () {
        (function () {
            var html = '',
                mainImg, mainImgAttr;
            mainImg = $('img.zoom_img_sm');
            $(mainImg).parent().addClass('zoom_img_parent');
            html += '<div class="zoom_img_hov">', html += '<div class="inner">', html += '<div class="ver-cen-out">', html += '<div class="ver-cen-inn">', html += '<img src="" alt="" class="zoom_img_lg"/>', html += '</div>', html += '</div>', html += '</div>', html += '</div>';
            $(mainImg).hover(function () {
                mainImgAttr = $(this).attr('src');
                $(this).toggleClass('active');
                if ($(this).hasClass('active')) {
                    $(this).after(html);
                    $(this).next('.zoom_img_hov').find('.zoom_img_lg').attr('src', mainImgAttr);
                } else {
                    $(this).next('.zoom_img_hov').remove();
                }
            });
        })();
