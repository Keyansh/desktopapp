...
<section id="main-form">
        <div class="container-fluid">
            <div class="col-xs-12 form-content ">
                ...
                <div class="col-xs-12 col-md-8 form-row1">
                    <form id="mainForm" action="">
                        <table class="table form-table">
                            ...
                            <tbody>
                                <?php if($getDetails){
                                $hold_data =    json_decode($getDetails['order_data'])->hold_data ;
                                $html = '';
                                $i = 1;
                                    foreach ($hold_data as $item){
                                        $html .=  '<tr class="container-qty">';
                                        $html .= ' <td class="dynamic">'.$i.'</td>';
                                        $html .=  '<td><input type="text" name="name[]" value="' . $item->name . '" readonly></td>';
                                        $html .=  ' <td><input type="text" class="qty" name="qty[]" value ="' . $item->qty . '" class="qty"></td>';
                                        $html .=  ' <td><input type="text" class="mrp" name="mrp[]" value="' . $item->mrp . '" placeholder="MRP"></td>';
                                        $html .=  '<td><input type="text" class="discount" name="discount[]" value="' . $item->discount . '" placeholder="Discount"></td>';
                                        $html .=  '<td><input type="text" class="amount" name="amount[]" value="' . $item->amount . '" placeholder="Amount" readonly></td>';
                ...
                <div class="btn1"><button type="button" class="submit-sub-cat" data-id="Takeaway"> Takeaway</button></div>
    ...
    <script>
        ...
        function totalfunction(){
          ...
          var  total2 = 0;
            ...
            var totaldic = total + total2;
            $('#amountotal').html(totaldic);
        }
