                                        ...
                                        <tr>
                                            <td style="border-top: 15px solid #060e9f; padding-bottom: 0px;">
                                                <table style="width:100%; border:0; box-shadow:1px 3px 5px 3px #88888880; padding: 0px; background:white; ">
                                                        ...
                                                        <td colspan="2" style="padding: 0 0px;">
                                                            <table style="font-family: roboto; font-weight: 300; color: #333333; font-size: 14px; width: 100%; border-collapse:collapse;">
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        <td colspan="3">
                                                                            <h1 style="color: #060e9f; text-align:center; text-transform:capitalize; font-size: 20px; font-weight:700; font-family: 'Heebo', sans-serif;">
                                                                                A New enquiry has been Placed. See below For enquiry details:
                                                                            </h1>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                    ...
                                                                    <tr>
                                                                        <td colspan="3" style="padding-left: 110px;">
                                                                            <label class="containerContact"> Agree to be contacted by our team
                                                                                <input type="checkbox" <?php echo  CONTACT_TEAM ? 'checked' : '' ?>>
                                                                    ...
                                                                    <tr>
                                                                        <td colspan="3" style="padding-left: 110px;padding-bottom: 60px;">
                                                                            <label class="containerContact"> Agree to join our mailing list
                                                                                <input type="checkbox" <?php echo  JOIN_MAIL ? 'checked' : '' ?>>
                                                                                <span class="checkmark"></span>
                                                                            </label>
                                                                        </td>
                                                    ...
                                                    <!-- <tr>
                                                            <td colspan="2" style="text-align: center; font-family: 'Heebo', sans-serif; font-weight: 400; font-size: 15px; color: #000;">
