...
//                    e($blog);
                                $blog_view .= '<ul>'
                                        ...
                                        . ' <img src="'. $this->config->item('BLOG_THUMBNAIL_URL') . $value['blog_image'].'" alt="'.$value['blog_title'].'" style="width:100%" class="img-responsive" />'
                                        . '<div class="blog-trangle"></div>'
                                        . '<div class="blog-date">'.$date[0].'<br/>'.$date[1].'</div>'
                                        . '</div>'
                                        . '</li>'
                                        . '<li>'
