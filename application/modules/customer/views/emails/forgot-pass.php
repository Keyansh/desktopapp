                                        ...
                                        <tr>
                                            <td style="border-top: 15px solid #060e9f; padding-bottom: 20px;">
                                                <table style="width:100%; border:0; box-shadow:1px 3px 5px 3px #88888880; padding: 40px 0px 0px 0px; background:white;">
                                                    ...
                                                    <tr>
                                                        <td style="text-align:center; padding-top: 25px;  font-family: 'Heebo', sans-serif; font-weight: 500; font-size:19px; color:black;padding: 10px 10px;padding-bottom: 100px;padding-top: 50px;">
                                                            {FORGOT_LINK}
                                                        </td>
                                                    </tr>
