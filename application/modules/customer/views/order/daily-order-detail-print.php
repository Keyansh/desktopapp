<<div class="daily_order_print" style="font-size:16px;">
	...
	<strong>
		...
		<p>
			...
			Location: <?php echo $loaction_title; ?><br />
			Delivery date: <?php echo cms_ustouk_date($delivery_date); ?><br />
			Delivery time: <?php echo $location_delivery_time; ?><br />
			Order No: <?php echo $order_num; ?>
		</p>
	</strong>
</div>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="grid">
	...
	<tr>
		...
		<td>&nbsp;</td>
		<td>&nbsp;</td>
		<td style="border-top: 1px solid #000;"><b>&pound;<?php echo $cart_total; ?></b></td>
	</tr>
</table>
