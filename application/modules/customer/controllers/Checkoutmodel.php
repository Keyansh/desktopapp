...
class Checkoutmodel extends CI_Model {
    ...
    function addOrder($customer, $order_total) {
        ...
        $order['order_total'] = ($order_total+($order_total * (DWS_VAT/100)) + $delivery_charge);
        $order['vat'] = DWS_VAT;
...
//            $order_item['order_item_options'] = base64_encode(serialize($item['options']));
    ...
    function orderConfirmed($sorder) {
        ...
        $emailData['title'] = "CREATE NEW ORDER";
        ...
        $subject = 'the subject';
        $message = 'hello';
        $headers = 'From: devrohit46@gmail.com' . "\r\n" .
        'Reply-To: devrohit46@gmail.com' . "\r\n" .
