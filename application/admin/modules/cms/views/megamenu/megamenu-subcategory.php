...
<h3 class="title-hero clearfix">
    Manage Menus
    <a href="cms/megamenu/" class="pull-right btn btn-primary">Back to main menu</a>
</h3>
<?php
...
<div class="panel">
    <div class="panel-body">
        <div class="example-box-wrapper">
            <div class="row">
                <div class="col-md-12">
                    <form action='cms/megamenu/subcategory_add' method="post">
                                ...
                                <tbody>
                                    ...
                                    foreach ($ActiveSubcategory as $item) {
                                        ...
                                        <tr>
                                            ...
                                            <?php } else { ?>
                                                <td data-title="Order"><input type="text" disabled="" name="order-<?php echo $item['category_id']; ?>" class="order-<?php echo $item['category_id']; ?>" ></td>
                                                <td data-title="Enable/Disable">
                                            ...
                                            <?php } ?>
                                            <td data-title="Action"><a href="cms/megamenu/sub_subcategory/<?php echo $item['category_id']; ?>">Menu Items</a> </td>
                                        </tr>
                                    <?php } ?>
                                </tbody>
                            </table>
