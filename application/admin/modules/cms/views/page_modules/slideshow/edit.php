<table width="100%" border="0" cellspacing="0" cellpadding="2" class="formtable">
    <tr>
        ...
        <td width="85%"><?php echo form_dropdown('slideshow_id', $slideshow, set_value('slideshow_id', $current_slideshow['page_setting_value']), ' id="slideshow_id" class="form-control"'); ?></td>
    </tr>
    <tr>
