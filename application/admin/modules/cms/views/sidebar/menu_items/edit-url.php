...
<h3 class="title-hero clearfix">
    ...
    <div class="pull-right">
        <a href="cms/sidebar/index" class="btn btn-info" style="background: #495d80;">
            Manage Sidebar Menus
        </a>
        <a href="cms/sidebar_menu_item/index/<?php echo $menu_item['menu_id']; ?>" class="btn btn-info" style="background: #495d80;">
            Manage Menu Items
        </a>
    </div>
</h3>
        ...
        <div class="example-box-wrapper">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <form action="cms/sidebar_menu_item/editurl/<?php echo $menu_item['menu_item_id']; ?>" method="post" enctype="multipart/form-data" name="regFrm" id="regFrm">
...
<script>
    $(document).ready(function () {
        $(".js-data-example").select2({
            ...
            allowClear: true,
            ajax: {
                url: DWS_BASE_URL + 'cms/sidebar_menu_item/child_categories',
                dataType: 'json',
                delay: 100,
                type: 'GET',
