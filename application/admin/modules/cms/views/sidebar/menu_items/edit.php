<h3 class="title-hero clearfix">
    ...
    <div class="pull-right">
        ...
        <a href="cms/sidebar_menu_item/index/<?php echo $menu_item['menu_id']; ?>" class="btn btn-info" style="background: #094e91;">
            Manage Menu Items
        </a>
    </div>
</h3>
        ...
        <div class="example-box-wrapper">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <form action="cms/sidebar_menu_item/edit/<?php echo $menu_item['menu_item_id']; ?>" method="post" enctype="multipart/form-data" name="regFrm" id="regFrm">
                        ...
                        <div class="form-group clearfix hide_for_cat">
                            ...
                            <div class="col-sm-7">
                                <?php echo form_dropdown('page_id', $pages, set_value('page_id', $menu_item['page_id']), ' class="form-control"'); ?>
                            </div>
                        </div>
