<h3 class="title-hero clearfix">
    ...
    <div class="pull-right">
        ...
        <a href="cms/menu_item/index/<?php echo $menu_detail['menu_id']; ?>" class="btn btn-info" style="background: #094e91;">
            Manage Menu Items
        </a>
    </div>
</h3>
        ...
        <div class="example-box-wrapper">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <form action="cms/menu_item/placeholder/<?php echo $menu_detail['menu_id']; ?>" method="post" enctype="multipart/form-data" name="regFrm" id="regFrm">
