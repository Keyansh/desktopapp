<h3 class="title-hero clearfix">
    ...
    <div class="pull-right">
        <a href="cms/menu/index" class="btn btn-info" style="background: #ffd32c;">
            Manage Menus
        </a>
        <a href="cms/menu_item/index/<?php echo $menu_item['menu_id']; ?>" class="btn btn-info" style="background: #ffd32c;">
            Manage Menu Items
        </a>
    </div>
</h3>
        ...
        <div class="example-box-wrapper">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <form action="cms/menu_item/update_url/<?php echo $menu_item['menu_item_id']; ?>" method="post" enctype="multipart/form-data" name="regFrm" id="regFrm">
