            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div id="tabs">
                        ...
                        <form action="cms/block/add/<?php echo $pages['page_id']; ?>" method="post" enctype="multipart/form-data" name="add_frm" id="add_frm">
                            <div id="tabs-1" class="tab">
                                ...
                                <div class="form-group clearfix">
                                    ...
                                    <div class="col-sm-7">
                                        <select name="block_type_id" class="form-control">
                                            ...
                                            <?php
                                            foreach ($block_type as $key => $block_type) {
                                                echo '<option value="' . $key . '">' . $block_type . '</option>';
                                            }
                                            ?>
                                        </select>
                                    </div>
                                ...
                                <div class="form-group clearfix">
                                    ...
                                    <div class="col-sm-7">
                                        <?php echo form_dropdown('block_template_id', $block_template, set_value('block_template_id'), ' class="form-control"'); ?>
                                    </div>
                                </div>
                                <div class="form-group clearfix">
                                    <label class="col-sm-2 control-label">Block Content</label>
                                    <div class="col-sm-12" style="display: table;">
                                        <textarea name="block_contents" class="form-control" id="block_contents" style="width:99%" cols="25" rows="5"><?php echo set_value('block_alias'); ?></textarea>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group clearfix">
                                <div class="col-sm-12 text-center">
                                    ...
                                    <input name="page_id" type="hidden" id="page_id" value="<?php echo $pages['page_id']; ?>" />
