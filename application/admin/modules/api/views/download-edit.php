<h3 class="title-hero clearfix">
    Update PDF
    <a href="gallery" class="pull-right btn btn-primary">Manage PDF</a>
</h3>
                            ...
                            <div class="tab-pane fade active in" id="main">
                                ...
                                <div class="form-group clearfix">
                                    ...
                                    <option value=" "> - select - </option>
                                       <option value="brochures" <?php if ($download['type'] == 'brochures') { echo ('selected'); }?>> Brochures </option>
                                       <option value="price_lists" <?php if ($download['type'] == 'brochures') { echo ('price_lists'); }?>> Price Lists </option>
