        ...
        <div class="example-box-wrapper">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <form action="homepage/topcat/edit/<?= $topcat['id'] ?>" method="post" enctype="multipart/form-data" name="add_frm" id="add_frm">
                            ...
                            <div class="col-sm-10">
                                <select name="category" class="form-control" id="catid">
                                    ...
                                    <?php foreach ($categories as $category) { ?>
                                        <option value="<?= $category['id']; ?>" <?= ($category['id'] == $topcat['category']) ? 'selected' : '' ?>><?= $category['name']; ?></option>
                                    <?php } ?>
                                </select>
                            </div>
                        </div>
                        <div class="form-group clearfix">
                            ...
                            <div class="col-sm-10">
                                <?php if ($topcat['image'] != '') { ?> 
                                    <img src="<?php echo $this->config->item('CATEGORY_THUMBNAIL_URL') . $topcat['image']; ?>" border="0" width="100px"/><br />
                                <?php } ?>
                        ...
                        <div class="form-group clearfix">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="alt" id="alt" class="form-control" size="35px" value="<?php echo set_value('alt', $topcat['alt']); ?>">
                            </div>
                        </div>
                        <div class="form-group clearfix">
                            <label class="col-sm-2 control-label">Price</label>
                            <div class="col-sm-10">
                                <input type="text" name="price" id="price" class="form-control" size="35px" value="<?php echo set_value('price', $topcat['price']); ?>">
                            </div>
                        </div> 
                        <div class="form-group clearfix">
