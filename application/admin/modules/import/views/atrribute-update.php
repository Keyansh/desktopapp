    ...
    <table width="100%" border="0" align="center" cellpadding="2" cellspacing="0" class="formtable manage-by-me-table">
        <tr>
            ...
            <td width="78%" VALIGN="middle">
                <label class="control-label" style="font-weight: normal;">Update Attribute</label>
<!--                <select name="type" class="form-control">
        ...
        <tr>
            <td colspan="2" style="text-align: center !important;">
                ...
                <input type="submit" name="button" class="btn btn-lg btn-primary" id="button" value="Submit" style="display: inline-block;">
            </td>
        </tr>
    </table>
</form>
