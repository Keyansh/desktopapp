...
<div class="panel">
    <div class="panel-body">
        ...
        <form action="adbanner/edit/<?php echo $banner['id'] ?>" method="post" enctype="multipart/form-data" name="add_frm" id="add_frm">
                ...
                <div id="myTabContent" class="tab-content">
                    <div class="tab-pane fade active in" id="main">
                        ...
                        <div class="form-group clearfix">
                            ...
                            <div class="col-sm-6">
                                <input name="alt" type="text" class="form-control" value="<?php echo set_value('alt', $banner['alt']); ?>">
                            </div>
                        </div>
                        ...
                        <div class="form-group clearfix">
                            ...
                            <div class="col-sm-6">
                                <input name="link" type="text" class="form-control" value="<?php echo set_value('link', $banner['link']); ?>" size="40">
                            </div>
                        </div>
                        ...
                        <div class="form-group clearfix">
                            ...
                            <div class="col-sm-6">
                                <input name="heading" type="text" class="form-control" value="<?php echo set_value('heading', $banner['heading']); ?>">
                            </div>
                        </div>
                        ...
                        <div class="form-group clearfix">
                            ...
                            <div class="col-sm-6">
                                <textarea name="description"  class="form-control" id="description"><?php echo set_value('description', $banner['description']); ?></textarea>
                            </div>
                        </div>
