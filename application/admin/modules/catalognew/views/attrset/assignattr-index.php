...
<style>
    .atributes, .categories, .addattributes{float: left;  margin-right: 30px;}
    .atributes h4, .categories h4, .addattributes h4 {margin:20px 0 0 0;font-size:14px;}
    .menulinks, .attrcontainer {list-style-type:none;margin:0;padding:0;margin-bottom:10px; position:relative;float:left;width:170px;border:1px solid #DFDFDF;margin-right:10px;min-height:100px;}
...
<div class="panel">
    <div class="panel-body">
        ...
        <div class="atributes col-xs-6" style="max-height: 480px;overflow: scroll;">
            <ul class="menulinks">
                <?= $attributes; ?>
            </ul>
        </div>

        <div class="addattributes col-xs-6">
            <form method="post" action="catalog/attrset/attrassign/<?= $attrset['id']; ?>">
                <div class=""  style="max-height: 480px;overflow: scroll;">
