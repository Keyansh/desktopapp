...
<div class="panel">
    <div class="panel-body">
        ...
        <form action="catalognew/product/duplicate/<?php echo $product['id']; ?>" method="post" enctype="multipart/form-data" name="addcatform" id="addcatform">
            ...
            <div class="example-box-wrapper">
                ...
                <div id="myTabContent" class="tab-content">
                    <div class="tab-pane fade active in" id="tabs-0">
                        ...
                        <div class="form-group clearfix col-xs-12 col-sm-6">
                            <label class="col-sm-2 control-label block-element">Select Brand</label>
                            <div class="col-sm-6 block-element">
                        ...
                        <div class="form-group clearfix col-xs-12 col-sm-6">
                            <label class="col-sm-2 control-label block-element">Product URI</label>
                            <div class="col-sm-6 block-element"><input name="uri" type="text" class="form-control" id="uri" value="<?php echo set_value('uri'); ?>" size="40">&nbsp;(Will be auto-generated if left blank)</div>
                        </div>
                        <div class="form-group clearfix col-xs-12 col-sm-6">
                        ...
                        <?php } ?>
                        <div class="form-group clearfix col-xs-12 col-sm-6">
                            <label class="col-sm-2 control-label block-element">Price </label>
                            <div class="col-sm-6 block-element">
                                <?php
                                if ($product['price'] > 0) {
                                    ?>
...
//                            e($least_price);
                            ...
                            <div class="col-xs-12" style="padding: 0px;">
                                <div class="form-group clearfix col-xs-12 col-sm-6">
                                    <label class="col-sm-2 control-label block-element">Least price <small><span class="error">*</span></small></label>
                                    <div class="col-sm-6 block-element">
                                        <input name="least_price" type="text" class="form-control" id="sku" value="<?php echo set_value('least_price', $least_price); ?>" size="40">
                                    </div>
                                </div>
                                <div class="form-group clearfix col-xs-12 col-sm-6" style="margin: 24px 0 0 0;">
                                    <label class="col-sm-2 control-label block-element"></label>
                                    <div class="col-sm-6 block-element">
                        ...
                        ?>
                        <div class="form-group clearfix col-xs-12 col-sm-6">
                            <label class="col-sm-2 control-label block-element">Manufacturer's Suggested Retail Price</label>
                            <div class="col-sm-6 block-element"><input name="srp_price" type="text" class="form-control" id="srp_price" value="<?php echo set_value('srp_price', $product['srp_price']); ?>" size="40"></div>
                        </div>
                        <!--                        <div class="form-group clearfix col-xs-12 col-sm-6">
                                                    <label class="col-sm-2 control-label block-element">Tier Price <small><span class="error"></span></small></label>
                                                    <div class="col-sm-6 block-element">
                        ...
                        <div class="form-group clearfix col-xs-12 col-sm-6" id="min-bundle-qty">
                            <label class="col-sm-2 control-label block-element">Bundle Quantity </label>
                            <div class="col-sm-6 block-element"><input name="bundle_qty" type="text" class="form-control" id="bundle_qty" value="<?php echo set_value('bundle_qty', $product['bundle_qty']); ?>" size="40"><small>Only numbers e.g. 0,10,100 etc.</small></div>
                        </div>
                        <div class="form-group clearfix col-xs-12 col-sm-6">
                            <label class="col-sm-2 control-label block-element">Quantity <small><span class="error">*</span></small></label>
                        ...
                        <!--                        <div class="form-group clearfix col-xs-12 col-sm-6">
                                                    <label class="col-sm-2 control-label block-element">Alert Quantity <small><span class="error">*</span></small></label>
                                                    <div class="col-sm-6 block-element"><input name="alert_qty" type="number" class="form-control" id="alert_qty" value="<?php echo set_value('alert_qty', $product['alert_qty']); ?>" size="40"></div>
                                                </div>-->
                        ...
                        ?>
                        <div class="form-group clearfix col-xs-12 col-sm-6" style="<?= $style ?>">
                            <label class="col-sm-2 control-label block-element">Minimum Order Quantity</label>
                            <div class="col-sm-6 block-element"><input name="min_order_quantity" type="number" class="form-control" id="min_order_quantity" value="<?php echo set_value('min_order_quantity', $product['min_order_quantity']); ?>" size="40"></div>
                        </div>
                            ...
                            <div class="col-xs-12">
                                <div class="panel panel-default">
                                    ...
                                    <div id="full-description" class="panel-collapse collapse">
                                        <div class="panel-body">
                                            <div class="form-group clearfix col-xs-12">
                                                <label class="col-sm-2 control-label block-element">Full Description </label>
                        ...
                        <div class="col-xs-12">
                            <div class="col-xs-12">
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h4 class="panel-title accordHeader">
                                            <a data-toggle="collapse" href="#product-dimensions">
                                                <i class="fa fa-caret-right" aria-hidden="true"></i>
                                                Product Dimensions
                                            </a>
                                        </h4>
                                    </div>
                                    <div id="product-dimensions" class="panel-collapse collapse">
                                        <div class="panel-body">
                                            <div class="form-group clearfix col-xs-12">
                                                <label class="col-sm-2 control-label block-element">Product Dimensions</label>
                                                <div class="col-sm-12 block-element"><textarea name="dimensions" style="width:100%" class="form-control"><?php echo set_value('dimensions', $product['dimensions']); ?></textarea></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-xs-12">
                                <div class="panel panel-default">
                                    ...
                                    <div id="collapse1" class="panel-collapse collapse">
                                        <div class="panel-body">
                                            <div class="form-group clearfix col-xs-12">
                                                <label class="col-sm-2 control-label block-element">Product Tags</label>
                                                <div class="col-sm-12 block-element"><textarea name="tags" style="width:100%" class="form-control"><?php echo set_value('tags', $product['tags']); ?></textarea></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-xs-12">
                            <div class="col-xs-12">
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h4 class="panel-title accordHeader">
                                            <a data-toggle="collapse" href="#product-specifications">
                                                <i class="fa fa-caret-right" aria-hidden="true"></i>
                                    ...
                                    <div id="product-specifications" class="panel-collapse collapse">
                                        <div class="panel-body">
                                            <div class="form-group clearfix col-xs-12">
                                                <label class="col-sm-2 control-label block-element">Product Specifications</label>
                                                <div class="col-sm-12 block-element">
                                                    <textarea name="product_specifications" style="width:100%;height:100px;" class="form-control" id="brief_description"><?php echo set_value('product_specifications', $product['product_specifications']); ?></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="col-xs-12" style="padding: 0px;">
                            <div class="form-group clearfix col-xs-12 col-sm-3">
                                <label class="col-sm-2 control-label block-element">Is Featured</label>
                                <div class="col-sm-6 block-element">
                            ...
                            <div class="form-group clearfix col-xs-12 col-sm-3">
                                <label class="col-sm-2 control-label block-element">Is Taxable</label>
                                <div class="col-sm-6 block-element">
                            ...
                            <div class="form-group clearfix col-xs-12 col-sm-3">
                                <label class="col-sm-2 control-label block-element">Product Price is</label>
                                <div class="col-sm-6 block-element">
                        ...
                        <!-- <div class="form-group clearfix">
                            ...
                            <div class="col-sm-6">
                                <input type="radio" name="is_bespoke" value="1" <?php //echo set_radio('is_bespoke', 1, ($product['is_bespoke'] == 1));                                                                                                                  ?> />Yes
                                <input type="radio" name="is_bespoke" value="0" <?php //echo set_radio('is_bespoke', 0, ($product['is_bespoke'] == 0));                                                                                                                  ?> />NO
                    ...
                    <div class="tab-pane fade clearfix" id="tabs-4">
                        ...
                        <div class="panel-group childProductAccordion">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h4 class="panel-title">
                                        <a data-toggle="collapse" href="#childProductTable">
                                            Child Products (<?= !empty($child_ids) ? count($child_ids) : '0'; ?>)
                                            <i class="fa fa-caret-right" aria-hidden="true"></i>
                                        </a>
                                    </h4>
                                </div>
                                <div id="childProductTable" class="panel-collapse collapse">
                                    <div class="panel-body">
                                        <div class="childprod">
                                            ...
                                            <div class="childprod">
                                                <div class="child-product-accordion">
...
<?php if (($product['type'] == 'config') || ($product['type'] == 'bundle')): ?>
                    ...
                    $(document).ready(function () {
                        ...
                        //                        if($('.accessory-input-control').is('checked')){
                        //                            alert(12);
                        //                        }
                        ...
                        $objDT.DataTable({
                            ...
                            "columns": [
                                ...
                                },
                                {
                                    "data": "assign",
                                    render: function (data, type, row, meta) {
                                        onclick = "location=\'<?php echo base_url(); ?>catalognew/product/edit/' + row.id + '\'"
                    ...
                    //                    $(document).on('click', '#datatable-example tr', function () {
                    ...
                    $objDT.on("click", ".bt-updch", function () {
                        ...
                        /*$.post('catalognew/product/chld_update', {
                         product_id: id,
                         price:pro_price,
...
<?php endif; ?>
                $("#addTier").click(function (event) {
                    ...
                    var tierRow = '<tr><td><select name="tier_profgroup[]" id="tier_profgroup" class="form-control"><option value="">Select Profile</option><option value="0">All</option>' + '<?php
if ($profileGroup) {
...
?>' + '</select></td><td><input name="tier_qty[]" class="form-control" id="tier_qty" value="" size="40" type="text"></td><td><input name="tier_price[]" class="form-control" id="tier_price" value="" size="40" type="text"></td><td><a href="javascript:void(0);" class="btn btn-danger" onclick="removeTier(this)" >Remove</a></td></tr>';
    ...
    /*$("#selectedProductss").on("click", ".removeSelectedPrd", function () {
     ...
     proDucts += '<td><a href="catalognew/product/edit/' + $pdObj.id + '">' + $pdObj.name + '</a></td>';
                ...
                $(document).ready(function () {
                    ...
                    $('#submitImageInfo').on("click", function (e) {
                        ...
                        $(".pimagesort").each(function () {
                            mainArray.push({'image_id': $(this).attr("data-iid"), 'pid': $(this).attr("data-pid"), 'sort_order': $(this).val()});
                        });


                        $(".Imgdesc").each(function (i, h) {
                            imgDesc.push({'image_id': $(this).attr("data-iid"), 'pid': $(this).attr("data-pid"), 'desc': $(this).val()});
                        });
                        ...
                        $.ajax({
                            url: post_url,
                            type: "POST",
                            data: {pid: pid, sort_order: mainArray, imgDesc: imgDesc}
