                ...
                <div id="myTabContent" class="tab-content">
                    <div class="tab-pane fade active in" id="main">
                        ...
                        <div class="form-group clearfix">
                            ...
                            <div class="col-sm-6">
                                <?php
                                    if ($current_category['category_banner']) {
                                        ?>
                                            <img src="<?php echo $this->config->item('CATEGORY_BANNER_URL') . $current_category['category_banner']; ?>" style="width:150px;height:100px;" />
                                            <br />
                                        <?php
                                    }
                                ?>
