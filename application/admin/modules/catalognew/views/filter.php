...
<div class="row">
    ...
    <div class="col-md-6">
        <div id="ctxmenu" class="pull-right">
            ...
            <a href="catalognew/product/filter" class="btn btn-success">View All</a>
        </div>
    </div>
</div>
...
echo form_open('catalognew/product/index', $attributes);
                ...
                <tr id="<?php echo $item['id']; ?>" class="<?php echo alternator('', ''); ?>">
                    ...
                    <td width="40%">
                        <?php if ($item['is_active'] == 1) { ?>
                            <a href="catalognew/product/disable/<?php echo $item['id'] ?>" onclick="return confirm('Are you sure you want to Disable this Product?');">Disable</a>
                        <?php } else { ?>
                            <a href="catalognew/product/enable/<?php echo $item['id'] ?>" onclick="return confirm('Are you sure you want to Enable this Product?');">Enable</a>
                        <?php } ?>
                        | <a href="catalognew/product/edit/<?php echo $item['id']; ?>">Edit</a>
                        | <a href="catalognew/product/delete/<?php echo $item['id'] ?>" onclick="return confirm('Are you sure you want to Delete this Product?');">Delete</a>
