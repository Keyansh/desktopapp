...
class Attribute extends Admin_Controller {
    ...
    function has_match() {
        ...
        if (!$exists) {
            ...
            $this->form_validation->set_message('has_match', 'Attribute name already exists');
            return false;
        }
    }
...
//        }
        //validation check
        $this->form_validation->set_rules('name', 'Attribute Name', 'trim|required|callback_has_match');
    ...
    public function delete($id) {
        ...
        redirect('catalog/attribute/index/');
    }
}
