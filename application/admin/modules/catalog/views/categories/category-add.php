            ...
            <div class="example-box-wrapper">
                ...
                <div id="myTabContent" class="tab-content">
                    <div class="tab-pane fade active in" id="main">
                        ...
                        <div class="form-group clearfix div-width-half">
                            <label class="col-sm-4 control-label">Category Template</label>
                            <div class="col-sm-6">
                        ...
                        <!-- <div class="form-group clearfix">
                            <label class="col-sm-4 control-label banner-width">Banner Content</label>
                        ...
                        <!-- <div class="form-group clearfix">
                            <label class="col-sm-4 control-label banner-width">Short Description</label>
                            <div class="col-sm-6 banner-width-input">
                    ...
                    <div class="tab-pane fade" id="metadata">
                        ...
                        <div class="form-group clearfix div-width-half">
                            ...
                            <div class="col-sm-8 width-input-field">
