                        ...
                        <div class="form-group clearfix">
                            ...
                            <div class="col-sm-6">
                                <?php if ($attributes_value['icon']) { ?>
                                    <img style="height:75px;width: 140px;" class="img-responsive" src="<?= $this->config->item('ATTRIBUTE_OPTION_ICON_URL') . $attributes_value['icon'] ?>"> 
                                <?php } ?>
                                <input name="icon" type="file" class=""/>
                                <?php if ($attributes_value['icon']) { ?>
                                    <a onclick="return confirm('Are you sure to delete this?')" href="<?= site_url('catalog/attribute_option/remove/' . $attributes_value['id']); ?>">remove icon</a>
                                <?php } ?>
                            </div>
                        </div>       
                        <div class="form-group clearfix">
