...
class Slideshow {
    ...
    function editView() {
        ...
        $current_slideshow = $this->CI->Pagemodel->getModuleData($this->page['page_id'], $this->getAlias(),'slideshow');

        $show_slideshow = array();
        $show_slideshow = $this->CI->Pagemodel->getModuleData($this->page['page_id'], $this->getAlias(), 'show_slideshow');
    ...
    function actionDelete() {
        ...
        $slideshow = array();
        $slideshow = $this->CI->Pagemodel->getModuleData($this->page['page_id'], $this->getAlias(), 'slideshow');
